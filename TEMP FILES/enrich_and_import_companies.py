...
1. Reads CSV file specified in keys.env (CSV_FILE_NAME)
...
Usage:
    python scripts/enrich_and_import_companies.py --limit 5
    python scripts/enrich_and_import_companies.py --domain microsoft.com
"""
...
def main():
    ...
    parser.add_argument("--csv", default=os.getenv("CSV_FILE_NAME", "leads_next_500_2026_01_08.csv"), help="Input CSV file")
